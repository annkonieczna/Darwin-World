...
- Dodatkowo wyróżniamy 2 sposoby renderowania mapy w zależności od rozmiaru pojedynczego pola (🙏 co łaska)  

## Dodatkowe informacje 

- Jeżeli na jednym polu znajduje się więcej niż jeden zwierzak, to są reprezentowane graficznie jako 3 zwierzaki, nie ważne od ilości (w obydwu wariantach mapy)

- Wyróżnianie popularnych pozycji spawnowania się trawy jest dodatkowo rozszerzone o popularne pozycje spawnoania się toksycznej trawy (pomarańczowy gradient)

- Dominujące zwierzaczki są kolorowane na niebiesko 
